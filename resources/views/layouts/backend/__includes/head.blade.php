<head>
    ...
    <meta content="{{ env('APP_URL') }}/assets/backend/media/app/og-image.png" name="twitter:image" />
    ...
    <meta content="{{ env('APP_URL') }}/assets/backend/media/app/og-image.png" property="og:image" />
    ...
    <link href="{{ env('APP_URL') }}/assets/backend/vendors/apexcharts/apexcharts.css" rel="stylesheet" />
