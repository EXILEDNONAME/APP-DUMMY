<head>
    ...
    <meta content="/assets/backend/media/app/og-image.png" name="twitter:image" />
    ...
    <meta content="/assets/backend/media/app/og-image.png" property="og:image" />
    <link href="/assets/backend/media/app/apple-touch-icon.png" rel="apple-touch-icon" sizes="180x180" />
    <link href="/assets/backend/media/app/favicon-32x32.png" rel="icon" sizes="32x32" type="image/png" />
