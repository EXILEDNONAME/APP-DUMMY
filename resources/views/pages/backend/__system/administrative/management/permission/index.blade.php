...
<th class="w-full"><span class="kt-table-col flex items-center justify-between"><span class="kt-table-col-label kt-card-title text-sm"> Created </span><span class="kt-table-col-sort"></span></span></th>
@endsection
